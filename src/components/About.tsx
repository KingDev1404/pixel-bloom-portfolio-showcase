      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="space-y-6">
              <h2 className="text-4xl font-bold pixel-text text-gradient">About Me</h2>
              ...
              <div className="flex gap-6 justify-center lg:justify-start mt-8">
                <div className="text-center p-6 pixel-card flex-1 max-w-xs">
              ...
              <div className="mt-12">
                <h3 className="text-xl font-bold pixel-text mb-6">Education</h3>
                <div className="space-y-4">
                  <div className="p-6 pixel-card">
                    <h4 className="text-lg font-semibold text-gradient mb-2">Bachelor of Technology - 2026</h4>
                    <p className="font-medium mb-1">Pimpri Chinchwad College Of Engineering</p>
                  ...
                  <div className="p-6 pixel-card">
                    ...
                    <p className="font-medium mb-1">Pratibha International School, Pune</p>
